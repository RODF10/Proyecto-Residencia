...
export class EncuestaPhq9Component {
    ...
    calcularPuntaje() {
      ...
      if (puntaje <= 4) observacion = 'Mínima existencia o ausencia de síntomas depresivos.';
      else if (puntaje <= 9) observacion = 'Síntomas depresivos leves.';
      else if (puntaje <= 14) observacion = 'Síntomas depresivos moderados.';
      else if (puntaje <= 19) observacion = 'Síntomas depresivos moderados a graves.';
      else observacion = 'Síntomas depresivos graves.';
